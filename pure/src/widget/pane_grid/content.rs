    ...
    Renderer: iced_native::Renderer,
{
    ...
    pub(crate) fn on_event(
        ...
        let (body_tree, body_layout) =
            if let Some(title_bar) = &mut self.title_bar {
                ...
                (&mut tree.children[1], children.next().unwrap())
            } else {
                (tree, layout)
            };
    ...
    pub(crate) fn mouse_interaction(
        ...
        let (body_tree, body_layout, title_bar_interaction) =
            if let Some(title_bar) = &self.title_bar {
                let mut children = layout.children();
                let title_bar_layout = children.next().unwrap();
                ...
                (tree, layout, mouse::Interaction::default())
            };
    ...
    pub(crate) fn overlay<'b>(
        ...
        if let Some(title_bar) = self.title_bar.as_mut() {
            ...
            self.body.as_widget_mut().overlay(tree, layout, renderer)
        }
    }
}
